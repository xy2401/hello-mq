...
> 七个产品各有一卷 8 页的讲解，全部按同一套公共维度展开：总览、快速开始、核心概念映射、路由/分发、可靠性、存储与高可用、运维与观测、陷阱与检查表。先读[基础原理](/fundamentals/)再进分卷，或直接用[横向矩阵](/matrix/)做比较。
...
| **ActiveMQ Artemis** | 多协议 JMS Broker（anycast/multicast、服务端重试与死信、XA 事务） | 2 个 | [进入分卷](/brokers/artemis/) |
