...
> 四个 P0 产品各有一卷 8 页的讲解，全部按同一套公共维度展开：总览、快速开始、核心概念映射、路由/分发、可靠性、存储与高可用、运维与观测、陷阱与检查表。先读[基础原理](/fundamentals/)再进分卷，或直接用[横向矩阵](/matrix/)做比较。
...
Redis Streams 与 NATS JetStream 为 P1 规划，不在当前范围。
