...
| Artemis | ✅ Address anycast/multicast + selector + Message Group（[routing](/brokers/artemis/routing)） | 无分片路由：扩展靠增加队列数并分布到集群节点 |
