...
- **产品分卷**：RabbitMQ、Kafka、RocketMQ、Pulsar（P0），Redis Streams、NATS JetStream（P1，规划中）。
...
| Redis Streams | ⏸ 不在当前范围 | Redis 内的追加日志与消费组 |
| NATS + JetStream | ⏸ 不在当前范围 | 低延迟 Core NATS 与持久化 JetStream |
